...
/*const { autocompletion, completionKeymap } = lazy(() =>
  import('@codemirror/autocomplete').then(module => ({
    autocompletion: module.autocompletion,
    completionKeymap: module.completionKeymap
  }))
);*/
...
const Template = props => {
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <SandpackProvider template={props.template}>
