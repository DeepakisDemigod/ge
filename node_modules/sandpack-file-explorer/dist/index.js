...
var CustomSandpackContext = React4.createContext(null);
var useSandpackFiles = () => {
  const context = React4.useContext(CustomSandpackContext);
  if (!context) {
    throw Error(
...
var SandpackFilesProvider = ({ children, onMoveFile }) => {
  ...
  const [treeData, setTreeData] = React4.useState(
    () => toHierarchicalArray(directoryFileMap({ ...sandpack.files }))
  );
  const [openDirs, setOpenDirs] = React4.useState([]);
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(CustomSandpackContext.Provider, {
    value,
    children
  });
};
...
function useFeatures(props, visualElement2, preloadedFeatures) {
  var features = [];
  var lazyContext = React4.useContext(LazyContext);
  if (!visualElement2)
    return null;
  ...
  for (var i = 0; i < numFeatures; i++) {
    ...
    if (isEnabled(props) && Component) {
      features.push(React4__namespace.createElement(Component, __assign({ key: name_1 }, props, { visualElement: visualElement2 })));
    }
  }
  return features;
}
...
var MotionContext = React4.createContext({});
function useVisualElementContext() {
  return React4.useContext(MotionContext).visualElement;
}
...
function useReducedMotion() {
  ...
  var _a = __read(React4.useState(prefersReducedMotion.current), 1), shouldReduceMotion = _a[0];
  return shouldReduceMotion;
}
function useReducedMotionConfig() {
  var reducedMotionPreference = useReducedMotion();
  var reducedMotion = React4.useContext(MotionConfigContext).reducedMotion;
...
function useVisualElement(Component, visualState, props, createVisualElement) {
  ...
  var presenceContext = React4.useContext(PresenceContext);
  var shouldReduceMotion = useReducedMotionConfig();
  var visualElementRef = React4.useRef(void 0);
...
function useCreateMotionContext(props) {
  var _a = getCurrentTreeVariants(props, React4.useContext(MotionContext)), initial = _a.initial, animate3 = _a.animate;
...
function useProjection(projectionId, _a, visualElement2, ProjectionNodeConstructor) {
  ...
  var initialPromotionConfig = React4.useContext(SwitchLayoutGroupContext);
...
function createMotionComponent(_a) {
  ...
  function MotionComponent(props, externalRef) {
    ...
    var config = React4.useContext(MotionConfigContext);
    var features = null;
    ...
    return React4__namespace.createElement(
      ...
      features,
      React4__namespace.createElement(MotionContext.Provider, { value: context }, useRender(Component, props, projectionId, useMotionRef(visualState, context.visualElement, externalRef), visualState, config.isStatic, context.visualElement))
    );
  }
  return React4.forwardRef(MotionComponent);
}
function useLayoutId(_a) {
  var _b;
  var layoutId = _a.layoutId;
  var layoutGroupId = (_b = React4.useContext(LayoutGroupContext)) === null || _b === void 0 ? void 0 : _b.id;
...
function useSVGProps(props, visualState) {
  var visualProps = React4.useMemo(function() {
...
function createUseRender(forwardMotionProps) {
  ...
  var useRender = function(Component, props, projectionId, ref, _a, isStatic) {
    ...
    return React4.createElement(Component, elementProps);
  };
  return useRender;
}
...
var makeUseVisualState = function(config) {
  return function(props, isStatic) {
    var context = React4.useContext(MotionContext);
    var presenceContext = React4.useContext(PresenceContext);
...
function useTapGesture(_a) {
  ...
  var isPressing = React4.useRef(false);
  var cancelPointerEndListeners = React4.useRef(null);
  var eventOptions = {
...
function usePresence() {
  var context = React4.useContext(PresenceContext);
  if (context === null)
    return [true, null];
...
function usePanGesture(_a) {
  ...
  var panSession = React4.useRef(null);
  var transformPagePoint = React4.useContext(MotionConfigContext).transformPagePoint;
  var handlers = {
...
function MeasureLayout(props) {
  var _a = __read(usePresence(), 2), isPresent = _a[0], safeToRemove = _a[1];
  var layoutGroup = React4.useContext(LayoutGroupContext);
  return React4.createElement(MeasureLayoutWithContext, __assign({}, props, { layoutGroup, switchLayoutGroup: React4.useContext(SwitchLayoutGroupContext), isPresent, safeToRemove }));
}
...
function useMeasure(_temp) {
  ...
  const [bounds, set] = React4.useState({
    left: 0,
    top: 0,
    width: 0,
    height: 0,
  ...
  const [forceRefresh, resizeChange, scrollChange] = React4.useMemo(() => {
    const callback = () => {
  ...
  React4.useEffect(() => removeListeners, []);
...
var DndContext = React4.createContext({
...
var DndProvider = /* @__PURE__ */ React4.memo(function DndProvider2(_param) {
...
function useCollector(monitor, collect, onUpdate) {
  const [collected, setCollected] = React4.useState(
    () => collect(monitor)
  );
  const updateCollected = React4.useCallback(() => {
...
function wrapHookToRecognizeElement(hook) {
  return (elementOrNode = null, options = null) => {
    if (!React4.isValidElement(elementOrNode)) {
...
function cloneWithRef(element, newRef) {
  ...
  if (!previousRef) {
    return React4.cloneElement(element, {
      ref: newRef
    });
  } else {
    return React4.cloneElement(element, {
...
function useDragDropManager() {
  const { dragDropManager } = React4.useContext(DndContext);
...
function useDragSourceConnector(dragSourceOptions, dragPreviewOptions) {
  ...
  const connector = React4.useMemo(
...
function useDropTarget(spec, monitor) {
  const dropTarget = React4.useMemo(
...
function AnimateHeight(props) {
  ...
  var _d = React4.useState(false), animating = _d[0], setAnimating = _d[1];
  ...
  return React4.createElement(
    ...
    React4.createElement("div", { ref }, children)
  );
}
...
var TreeContext = React4.createContext({});
var TreeProvider = function(props) {
  ...
  React4.useImperativeHandle(props.treeRef, function() {
    return {
  ...
  return React4.createElement(TreeContext.Provider, { value }, props.children);
};
var DragControlContext = React4.createContext({});
var initialState$1 = {
  isLock: false
};
var DragControlProvider = function(props) {
  var _a = React4.useState(initialState$1.isLock), isLock = _a[0], setIsLock = _a[1];
  return React4.createElement(DragControlContext.Provider, { value: {
    isLock,
    lock: function() {
...
var PlaceholderContext = React4.createContext({});
var initialState3 = {
  dropTargetId: void 0,
  index: void 0
};
var PlaceholderProvider = function(props) {
  var _a = React4.useState(initialState3.dropTargetId), dropTargetId = _a[0], setDropTargetId = _a[1];
  var _b = React4.useState(initialState3.index), index2 = _b[0], setIndex = _b[1];
  ...
  return React4.createElement(PlaceholderContext.Provider, { value: {
    dropTargetId,
    index: index2,
    showPlaceholder,
    hidePlaceholder
...
var Providers = function(props) {
  return React4.createElement(
    ...
    React4.createElement(
      DragControlProvider,
      null,
      React4.createElement(PlaceholderProvider, null, props.children)
    )
  );
};
var useDragControl = function(ref) {
  var dragControlContext = React4.useContext(DragControlContext);
  React4.useEffect(function() {
    if (!ref.current)
      return;
...
var useDropRoot = function(ref) {
  var treeContext = useTreeContext();
  var placeholderContext = React4.useContext(PlaceholderContext);
  var _a = useDrop({
...
var useOpenIdsHelper = function(tree, initialOpen) {
  var initialOpenIds = React4.useMemo(function() {
    if (initialOpen === true) {
  ...
  var _a = React4.useState(initialOpenIds), openIds = _a[0], setOpenIds = _a[1];
  React4.useEffect(function() {
...
var useTreeContext = function() {
  var treeContext = React4.useContext(TreeContext);
  if (!treeContext) {
...
var Node = function(props) {
  ...
  var handleRef = React4.useRef(null);
  ...
  return React4.createElement(
    ...
    enableAnimateExpand ? React4.createElement(
      AnimateHeight,
      { isVisible: open && hasChild },
      React4.createElement(Container, { parentId: props.id, depth: props.depth + 1 })
    ) : open && hasChild && React4.createElement(Container, { parentId: props.id, depth: props.depth + 1 })
  );
};
var Placeholder = function(props) {
  ...
  return React4.createElement(Component, { className: (classes === null || classes === void 0 ? void 0 : classes.placeholder) || "" }, placeholderRender(dragSource, { depth: props.depth }));
};
  ...
  return React4.createElement(
    ...
    view.map(function(node, index2) {
      return React4.createElement(
        React4.Fragment,
        { key: node.id },
        React4.createElement(Placeholder, { depth: props.depth, listCount: view.length, dropTargetId: props.parentId, index: index2 }),
        React4.createElement(Node, { id: node.id, depth: props.depth })
      );
    }),
    React4.createElement(Placeholder, { depth: props.depth, listCount: view.length, dropTargetId: props.parentId })
  );
};
var rootStyle = {
  height: "100%",
...
var DragLayer = function() {
  ...
  return React4.createElement(
    "div",
    { style: rootStyle },
    React4.createElement("div", { style: getItemStyles(monitorProps) }, context.dragPreviewRender && context.dragPreviewRender(monitorProps))
  );
};
function TreeInner(props, ref) {
  return React4.createElement(
    ...
    props.dragPreviewRender && React4.createElement(DragLayer, null),
    React4.createElement(Container, { parentId: props.rootId, depth: 0 })
  );
}
var Tree = React4.forwardRef(TreeInner);
var SingleInputForm = ({
  onSubmit,
  onBlur,
  isDirectory,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("form", {
    ...
    children: [
      ...
      error ? /* @__PURE__ */ jsxRuntime.jsx("span", {
        style: {
          display: "block",
          maxWidth: "100%",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(Tree, {
            ...
            render: (node, { depth, isOpen }) => {
              var _a, _b, _c, _d;
              return !node.text ? /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, {}) : /* @__PURE__ */ jsxRuntime.jsxs("div", {
                style: {
                  marginLeft: depth * 10,
                  display: "flex",
                  justifyContent: "space-between",
                ...
                children: [
                  node.text.includes("addFile") || node.text.includes("addDir") ? /* @__PURE__ */ jsxRuntime.jsx(SingleInputForm, {
                  ...
                  node.text && !node.text.includes("addFile") && !node.text.includes("addDir") ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, {
                    children: [
                      node.droppable ? /* @__PURE__ */ jsxRuntime.jsxs("span", {
                        style: {
...
var SandpackFileTree = () => /* @__PURE__ */ jsxRuntime.jsx("div", {
  style: {
    minWidth: 150,
    maxWidth: "300px",
    overflow: "hidden"
...
var SandpackFileExplorer = (props) => /* @__PURE__ */ jsxRuntime.jsx(SandpackFilesProvider, {
  ...props,
  children: /* @__PURE__ */ jsxRuntime.jsx(SandpackFileTree, {})
});
