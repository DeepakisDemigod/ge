import {
  ...
  FileIcon,
  useSandpack
} from "./chunk-OEYK3UL7.js";
import "./chunk-TLSYWXCA.js";
import {
  require_jsx_runtime
} from "./chunk-DVMXYLF7.js";
import {
  require_react
...
// node_modules/sandpack-file-explorer/dist/index.mjs
...
var buildPath = (item, arr) => {
  let path = "";
  let parent = arr.find(({ id: id2 }) => id2 === item.parent);
  if (parent) {
...
var CustomSandpackContext = (0, import_react.createContext)(null);
var useSandpackFiles = () => {
  const context = (0, import_react.useContext)(CustomSandpackContext);
  if (!context) {
    throw Error(
...
var SandpackFilesProvider = ({ children, onMoveFile }) => {
  ...
  const [openDirs, setOpenDirs] = (0, import_react.useState)([]);
  ...
  const addFile = async (files) => {
    for (let id2 in files) {
      if (sandpack.files[id2] || sandpack.files[id2.endsWith("/") ? id2.substring(0, id2.length - 1) : `${id2}/`]) {
        delete files[id2];
      }
    }
    ...
    const isAnInputNode = fileKeys.filter(
      (id2) => id2.includes("addDir") || id2.includes("addFile")
    ).length;
    if (!isAnInputNode) {
      ...
      fileKeys.forEach((id2) => {
        if (!id2.endsWith("/"))
          sandpack.openFile(id2);
      });
    } else {
  ...
  const getAllParentDirs = ({
    ...
    var _a;
    const ids = [];
    const itemParent = (_a = tree.find(({ id: id2 }) => id2 === childId)) == null ? void 0 : _a.parent;
  ...
  const onFileMoved = async ({
    ...
    const movedFileMap = removedKeys.reduce((acc, id2) => {
      var _a, _b, _c, _d, _e;
      ...
      acc[id2] = `${newPath}${id2.substring(
        id2.indexOf((_c = node == null ? void 0 : node.dragSource) == null ? void 0 : _c.id) + ((_e = (_d = node == null ? void 0 : node.dragSource) == null ? void 0 : _d.id) == null ? void 0 : _e.length)
      )}`;
      return acc;
    }, {});
  ...
  return (0, import_jsx_runtime.jsx)(CustomSandpackContext.Provider, {
    value,
    children
  });
};
...
function useFeatures(props, visualElement2, preloadedFeatures) {
  var features = [];
  var lazyContext = (0, import_react.useContext)(LazyContext);
  if (!visualElement2)
    return null;
  ...
  for (var i = 0; i < numFeatures; i++) {
    ...
    if (isEnabled(props) && Component) {
      features.push(React4.createElement(Component, __assign({ key: name_1 }, props, { visualElement: visualElement2 })));
    }
  }
  return features;
}
...
function useReducedMotion() {
  ...
  var _a = __read((0, import_react.useState)(prefersReducedMotion.current), 1), shouldReduceMotion = _a[0];
  return shouldReduceMotion;
}
function useReducedMotionConfig() {
  var reducedMotionPreference = useReducedMotion();
  var reducedMotion = (0, import_react.useContext)(MotionConfigContext).reducedMotion;
...
function useVisualElement(Component, visualState, props, createVisualElement) {
  ...
  var visualElementRef = (0, import_react.useRef)(void 0);
...
function useCreateMotionContext(props) {
  var _a = getCurrentTreeVariants(props, (0, import_react.useContext)(MotionContext)), initial = _a.initial, animate3 = _a.animate;
...
function useProjection(projectionId, _a, visualElement2, ProjectionNodeConstructor) {
  ...
  var initialPromotionConfig = (0, import_react.useContext)(SwitchLayoutGroupContext);
...
function createMotionComponent(_a) {
  ...
  function MotionComponent(props, externalRef) {
    ...
    var config = (0, import_react.useContext)(MotionConfigContext);
    var features = null;
    ...
    return React4.createElement(
      ...
      features,
      React4.createElement(MotionContext.Provider, { value: context }, useRender(Component, props, projectionId, useMotionRef(visualState, context.visualElement, externalRef), visualState, config.isStatic, context.visualElement))
    );
  }
...
function useLayoutId(_a) {
  ...
  var layoutGroupId = (_b = (0, import_react.useContext)(LayoutGroupContext)) === null || _b === void 0 ? void 0 : _b.id;
...
function useSVGProps(props, visualState) {
  var visualProps = (0, import_react.useMemo)(function() {
...
function createUseRender(forwardMotionProps) {
  ...
  var useRender = function(Component, props, projectionId, ref, _a, isStatic) {
    ...
    return (0, import_react.createElement)(Component, elementProps);
  };
  return useRender;
}
...
var makeUseVisualState = function(config) {
  return function(props, isStatic) {
    var context = (0, import_react.useContext)(MotionContext);
    var presenceContext = (0, import_react.useContext)(PresenceContext);
...
function useTapGesture(_a) {
  ...
  var isPressing = (0, import_react.useRef)(false);
  var cancelPointerEndListeners = (0, import_react.useRef)(null);
  var eventOptions = {
...
function MeasureLayout(props) {
  var _a = __read(usePresence(), 2), isPresent = _a[0], safeToRemove = _a[1];
  var layoutGroup = (0, import_react.useContext)(LayoutGroupContext);
  return import_react.default.createElement(MeasureLayoutWithContext, __assign({}, props, { layoutGroup, switchLayoutGroup: (0, import_react.useContext)(SwitchLayoutGroupContext), isPresent, safeToRemove }));
}
...
function AnimateHeight(props) {
  ...
  var _d = (0, import_react.useState)(false), animating = _d[0], setAnimating = _d[1];
  ...
  return import_react.default.createElement(
    motion.div,
    { style: isVisible && !animating ? {} : { overflow: "hidden" }, onAnimationComplete, onAnimationStart, initial: isVisible ? "open" : "close", animate: isVisible ? "open" : "close", inherit: false, variants, transition: { ease, duration: computeDuration(height, duration) } },
    import_react.default.createElement("div", { ref }, children)
  );
}
...
var TreeContext = (0, import_react.createContext)({});
var TreeProvider = function(props) {
  ...
  (0, import_react.useImperativeHandle)(props.treeRef, function() {
    return {
  ...
  return import_react.default.createElement(TreeContext.Provider, { value }, props.children);
};
var DragControlContext = (0, import_react.createContext)({});
var initialState$1 = {
  isLock: false
};
var DragControlProvider = function(props) {
  var _a = (0, import_react.useState)(initialState$1.isLock), isLock = _a[0], setIsLock = _a[1];
  return import_react.default.createElement(DragControlContext.Provider, { value: {
    isLock,
    lock: function() {
...
var PlaceholderContext = (0, import_react.createContext)({});
var initialState3 = {
  dropTargetId: void 0,
  index: void 0
};
var PlaceholderProvider = function(props) {
  var _a = (0, import_react.useState)(initialState3.dropTargetId), dropTargetId = _a[0], setDropTargetId = _a[1];
  var _b = (0, import_react.useState)(initialState3.index), index2 = _b[0], setIndex = _b[1];
  ...
  return import_react.default.createElement(PlaceholderContext.Provider, { value: {
    dropTargetId,
    index: index2,
    showPlaceholder,
    hidePlaceholder
...
var Providers = function(props) {
  return import_react.default.createElement(
    ...
    import_react.default.createElement(
      DragControlProvider,
      null,
      import_react.default.createElement(PlaceholderProvider, null, props.children)
    )
  );
};
var useDragControl = function(ref) {
  var dragControlContext = (0, import_react.useContext)(DragControlContext);
  (0, import_react.useEffect)(function() {
    if (!ref.current)
      return;
...
var useDropRoot = function(ref) {
  var treeContext = useTreeContext();
  var placeholderContext = (0, import_react.useContext)(PlaceholderContext);
  var _a = useDrop({
...
var useOpenIdsHelper = function(tree, initialOpen) {
  var initialOpenIds = (0, import_react.useMemo)(function() {
    if (initialOpen === true) {
  ...
  var _a = (0, import_react.useState)(initialOpenIds), openIds = _a[0], setOpenIds = _a[1];
  (0, import_react.useEffect)(function() {
...
var useTreeContext = function() {
  var treeContext = (0, import_react.useContext)(TreeContext);
  if (!treeContext) {
...
var Node = function(props) {
  ...
  var handleRef = (0, import_react.useRef)(null);
  ...
  return import_react.default.createElement(
    ...
    enableAnimateExpand ? import_react.default.createElement(
      AnimateHeight,
      { isVisible: open && hasChild },
      import_react.default.createElement(Container, { parentId: props.id, depth: props.depth + 1 })
    ) : open && hasChild && import_react.default.createElement(Container, { parentId: props.id, depth: props.depth + 1 })
  );
};
var Placeholder = function(props) {
  ...
  return import_react.default.createElement(Component, { className: (classes === null || classes === void 0 ? void 0 : classes.placeholder) || "" }, placeholderRender(dragSource, { depth: props.depth }));
};
  ...
  return import_react.default.createElement(
    ...
    view.map(function(node, index2) {
      return import_react.default.createElement(
        ...
        { key: node.id },
        import_react.default.createElement(Placeholder, { depth: props.depth, listCount: view.length, dropTargetId: props.parentId, index: index2 }),
        import_react.default.createElement(Node, { id: node.id, depth: props.depth })
      );
    }),
    import_react.default.createElement(Placeholder, { depth: props.depth, listCount: view.length, dropTargetId: props.parentId })
  );
};
var rootStyle = {
  height: "100%",
...
var DragLayer = function() {
  ...
  return import_react.default.createElement(
    "div",
    { style: rootStyle },
    import_react.default.createElement("div", { style: getItemStyles(monitorProps) }, context.dragPreviewRender && context.dragPreviewRender(monitorProps))
  );
};
function TreeInner(props, ref) {
  return import_react.default.createElement(
    ...
    props.dragPreviewRender && import_react.default.createElement(DragLayer, null),
    import_react.default.createElement(Container, { parentId: props.rootId, depth: 0 })
  );
}
var Tree = (0, import_react.forwardRef)(TreeInner);
var SingleInputForm = ({
  onSubmit,
  onBlur,
  isDirectory,
...
var CreateNewNode = ({ dir }) => {
  ...
  return (0, import_jsx_runtime.jsx)("span", {
    ...
    children: dir ? (0, import_jsx_runtime.jsx)(DirectoryIconOpen, {}) : (0, import_jsx_runtime.jsx)(FileIcon, {})
  });
};
        ...
        children: [
          (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              ...
              (0, import_jsx_runtime.jsxs)("div", {
                style: { display: "flex" },
                children: [
                  (0, import_jsx_runtime.jsx)(CreateNewNode, {}),
                  (0, import_jsx_runtime.jsx)(CreateNewNode, {
                    dir: true
                  })
                ]
          ...
          (0, import_jsx_runtime.jsx)(Tree, {
            ...
            render: (node, { depth, isOpen }) => {
              var _a, _b, _c, _d;
              return !node.text ? (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {}) : (0, import_jsx_runtime.jsxs)("div", {
                style: {
                  marginLeft: depth * 10,
                  display: "flex",
                  justifyContent: "space-between",
                ...
                children: [
                  node.text.includes("addFile") || node.text.includes("addDir") ? (0, import_jsx_runtime.jsx)(SingleInputForm, {
                  ...
                  node.text && !node.text.includes("addFile") && !node.text.includes("addDir") ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
                    children: [
                      node.droppable ? (0, import_jsx_runtime.jsxs)("span", {
                        style: {
                        ...
                        onClick: () => {
                          if (isOpen) {
                            setOpenDirs(
                              (prev) => prev.filter((id2) => id2 !== node.id)
                            );
                          } else {
                            setOpenDirs((prev) => [
                              ...prev,
                        ...
                        children: [
                          isOpen ? (0, import_jsx_runtime.jsx)(DirectoryIconOpen, {}) : (0, import_jsx_runtime.jsx)(DirectoryIconClosed, {}),
                          node.text,
                          isOpen ? "[-] " : "[+] "
                        ]
                        ...
                        children: [
                          (0, import_jsx_runtime.jsx)("span", {
                            ...
                            children: (0, import_jsx_runtime.jsx)(FileIcon, {})
                          }),
                          (0, import_jsx_runtime.jsx)("span", {
                            style: {
...
var SandpackFileTree = () => (0, import_jsx_runtime.jsx)("div", {
  style: {
    minWidth: 150,
    maxWidth: "300px",
    overflow: "hidden"
  },
  children: (0, import_jsx_runtime.jsx)(FileTreeExplorer, {})
});
var SandpackFileExplorer = (props) => (0, import_jsx_runtime.jsx)(SandpackFilesProvider, {
  ...props,
  children: (0, import_jsx_runtime.jsx)(SandpackFileTree, {})
});
export {
...
//# sourceMappingURL=sandpack-file-explorer.js.map
